  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        icon: Building2,
        description: "Required for Outlook and Teams integration. Create an App Registration in Azure Portal to get this. Make sure to add 'Mail.Read', 'Mail.Send', and 'User.Read' as delegated permissions.",
      ...
      },
      {
        ...
        placeholder: "~abc123...",
        icon: Building2,
        description: "A client secret (not a certificate) from your Azure App Registration. Go to 'Certificates & Secrets' in your app to create one.",
      },
      {
        key: "azure_tenant_id",
        ...
        icon: Building2,
        description: "Your organization's Azure AD tenant ID. Use 'common' if you want to allow any Microsoft account to sign in. Found in Azure Portal under 'Overview' of your App Registration.",
      },
    ],
  },
  {
